<?php
include_once $_SERVER["DOCUMENT_ROOT"]."/midnight/shared/bases/Configs.php";

if(!class_exists("Databases")) {
	class Databases extends Configs {

        public $database; // Database Connection
		...
		function req($key){
		    return mysqli_real_escape_string($this->database, $_REQUEST[$key]);
        }
