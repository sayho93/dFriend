<? include_once $_SERVER["DOCUMENT_ROOT"]."/midnight/admin/inc/header.php"; ?>
<?
...
<script>
    $(document).ready(function(){
        ...
        $(".jSubmit").click(function(){
            callJson(
                "/midnight/shared/public/route.php?F=WebRoute.saveQuery",
                {
                    userId : "<?=$_REQUEST["id"]?>",
                    title : $(".jTitle").val(),
                    isReply : 1,
        ...
        function loadMore(page){
            loadPageInto(
                "/midnight/ajaxPages/ajaxAdminQueryDetailList.php",
                {
                    id : "<?=$_REQUEST["id"]?>",
                    page : page,
        ...
        $(document).on("click", ".jDeny", function(e){
            ...
            e.stopPropagation();
            callJson(
                "/midnight/shared/public/route.php?F=WebRoute.denyQuery",
                {
...
<? include_once $_SERVER["DOCUMENT_ROOT"]."/midnight/admin/inc/footer.php"; ?>